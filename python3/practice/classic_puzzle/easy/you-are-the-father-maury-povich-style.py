...
father_chrom_parts = []
for mother_chrom_pair, child_chrom_pair in zip(mother_chrom_pairs, child_chrom_pairs, strict=True):
...
for a_possible_father in a_possible_fathers:
    ...
    is_father_check = []
    for a_possible_father_chrom_pair, father_chrom_part in (
        zip(a_possible_father_chrom_pairs, father_chrom_parts, strict=True)
    ):
